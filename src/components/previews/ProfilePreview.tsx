...
const ProfilePreview: React.FC<DetailProps<ProfileItem>> = ({ item, t }) => {
    ...
    <div className="flex-1 flex flex-col md:flex-row items-stretch gap-4 lg:gap-6 text-center md:text-left h-full">
      ...
      <div className="flex-1 flex flex-col justify-between py-2">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-slate-400 font-mono leading-relaxed line-clamp-4 pr-2">
      ...
      <div 
        ...
        className="relative w-40 h-56 md:w-56 md:h-72 lg:w-64 lg:h-80 rounded-2xl overflow-hidden border border-white/10 group-hover:border-cyan-500/50 transition-all shrink-0 cursor-crosshair mt-4 md:mt-0"
      >
